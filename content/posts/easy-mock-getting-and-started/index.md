---
title: Easy Mock 试玩
description: 在过去的开发模式中，或许是一群人坐在一起，风风火火的一起码一个项目，大家在一起，口头沟通交流，并不太涉及到跨团队间的数据调用，基本上涉及的API也是不断沟通修改。
date: 2017-09-03T12:38:11+08:00
slug: easy-mock-getting-and-started
...
![easy mock login](login.png)

![easy mock login input](login-input.png)
...
![easy mock project](my-project.png)

点击项目可以查看项目接口列表。

![easy mock project api](my-project-api.png)

### 团队项目

- 首先，我们来初始化一个团队。

![easy mock team](my-team-new.png)

- 新建团队项目

![easy mock team project](my-team-project-new.png)

- 编辑项目API

![easy mock team project api](my-team-project-api-edit.png)

- 预览项目API

![easy mock team project api previw](my-team-project-api-preview.png)
