...
slug: graph-db-getting-and-started
image: graph.png
categories:
    - Programming
tags:
...
![graph db friend links](friend-likes.png)
...
$ docker run -d \
    ...
    neo4j
```
![neo4j-dashboard](neo4j-dashboard.png)
